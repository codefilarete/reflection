...
/**
 * A dedicated version of {@link SerializableAccessor} for bean property : since there's no way to constraint a method
 ...
 */
@FunctionalInterface
public interface SerializablePropertyAccessor<C, T> extends PropertyAccessor<C, T>, SerializableAccessor<C, T> {
}
